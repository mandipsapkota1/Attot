...
<div class="header-1">
    ...
    <a href="index.php" class="logo" > <img src="website/all/Attot-Imports.png" alt="Logo image" class="hidden-xs">  </a>
  ...
  <footer class="footer" id="footer">
     <div class="cuntainer">
        <div class="wolf">
            ...
            <p class="credit">Copyright &copy; <span>2015-2024</span> | all rights reserved. | <span>Designed By Mandip Sapkota</span></p>
        </div>
     </div>
  </footer>
